...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/10/07 18:52:19 by fde-alen          #+#    #+#             */
/*   Updated: 2023/10/07 18:54:33 by fde-alen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void scrollhook(double xdelta, double ydelta, void* param)
{
	...
	else if (ydelta < 0)
	{
		...
		fractal_ptr->x_shift *= map(fractal_ptr->mouse_x, fractal_ptr->width, -2, +2) * fractal_ptr->zoom;
		fractal_ptr->y_shift *= map(fractal_ptr->mouse_x, fractal_ptr->height, +2, -2)* fractal_ptr->zoom;
	}
